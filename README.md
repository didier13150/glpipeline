...
```
cd existing_repo
git remote add origin https://gitlab.tartarefr.eu/sources/glpipeline.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.tartarefr.eu/sources/glpipeline/-/settings/integrations)
